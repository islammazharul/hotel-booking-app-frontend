...
const LatestDestinationCard = ({ hotel }: HotelProps) => {
  return (
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <p className="text-gray-300 font-bold text-sm ml-1">
              {hotel.starRating}
              <span className="text-gray-300 font-normal">(76 reviews)</span>
            </p>
          </div>
        </div>
      </div>
    ...
    //     <img
    //       src={hotel.imageUrls[0]}
    //       className="w-full h-full object-cover object-center bg-black bg-opacity-50"
    //     />
    //     {/* </div> */}
    ...
    //       />
    //     </div>
    //     <div className="absolute w-full md:w-2/3  flex flex-col space-y-2 p-3">
